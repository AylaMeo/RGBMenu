...
namespace AlsekRGB.Client
{
    ...
    {   
        ...
        public bool ApplyColor { get; private set; } = false;
        
        public static Control MenuToggleKey { get; set; } = Control.SelectCharacterMichael;
        ...
        public MainMenu()
        {
            ...
            ########################################################
            */       
            //Box for applying paint
            MenuCheckboxItem paint = new MenuCheckboxItem("Apply custom RGB", "This will make your paint apply as you change it")
            {
                Style = MenuCheckboxItem.CheckboxStyle.Tick
            };
            Color.AddMenuItem(paint);
            //Box for applying paint
